...
describe("LanguageSwitcher", () => {
  ...
  describe("mobile variant", () => {
    ...
    it("should show flags in mobile buttons", () => {
      ...
      expect(screen.getByText("Deutsch").closest("button")).toHaveTextContent(
        "🇩🇪Deutsch"
      );
      expect(screen.getByText("English").closest("button")).toHaveTextContent(
        "🇺🇸English"
      );
    });
  ...
  describe("style computations", () => {
    ...
    it("should apply mobile-specific styles", () => {
      ...
      const germanButton = screen.getByText("Deutsch");
      const englishButton = screen.getByText("English");
      expect(germanButton.closest("div")?.parentElement).toBe(
        englishButton.closest("div")?.parentElement
      );
    });
    ...
    it("should show active language styling in mobile variant", () => {
      ...
      const buttons = screen.getAllByRole("button");
      const germanButton = buttons.find((btn) =>
        btn.textContent?.includes("Deutsch")
      );
