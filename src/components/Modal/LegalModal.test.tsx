...
describe("LegalModal", () => {
  ...
  describe("Content rendering - Datenschutz", () => {
    it("should render datenschutz content with correct title", () => {
      ...
      expect(
        screen.getByText("Disclaimer - rechtliche Hinweise")
      ).toBeInTheDocument();
    });
    ...
    it("should render datenschutz main sections", () => {
      ...
      expect(
        screen.getByText("§ 1 Warnhinweis zu Inhalten")
      ).toBeInTheDocument();
      expect(screen.getByText("§ 2 Externe Links")).toBeInTheDocument();
      expect(
        screen.getByText("§ 3 Urheber- und Leistungsschutzrechte")
      ).toBeInTheDocument();
      expect(
        screen.getByText("§ 4 Besondere Nutzungsbedingungen")
      ).toBeInTheDocument();
    });
  ...
  describe("Modal behavior with different types", () => {
    it("should switch content when type changes", () => {
      ...
      expect(screen.getByText("Impressum")).toBeInTheDocument();
      expect(
        screen.queryByText("Disclaimer - rechtliche Hinweise")
