...
describe('StatCard', () => {
  ...
  it('should render with icon', () => {
    ...
    const iconContainer = screen.getByText('42').parentElement?.querySelector('div');
  ...
  it('should apply correct styling to card elements', () => {
    ...
    const card = screen.getByText('Test Title').closest('[class*="mantine-Card"]');
  ...
  it('should handle long text content', () => {
    renderComponent({
      ...
      value: '999999',
      description: 'This is a very long description that should wrap correctly and display all the content properly'
    });

    expect(screen.getByText('Very Long Title That Should Still Display Correctly')).toBeInTheDocument();
    expect(screen.getByText('999999')).toBeInTheDocument();
    expect(screen.getByText(/This is a very long description/)).toBeInTheDocument();
  });

  it('should render with different icon types', () => {
    const CustomIcon = (props: any) => <div data-testid="custom-icon" {...props}>Custom</div>;
