...
export const CompanyLogos = ({ onCompanyClick }: CompanyLogosProps) => {
  ...
  const companyLogos = [
    ...
    },
    {
      name: "Paessler AG",
      fileName:
        theme === "dark" ? "paessler-logo-dark-mode.png" : "paessler-logo.png",
    ...
    },
    {
      ...
      fileName:
        theme === "dark"
          ? "chatyourdata-logo-dark-mode.png"
          : "chatyourdata-logo.png",
        ...
        {companyLogos.map((company) => (
          ...
          >
            <img
              ...
              onError={(e) =>
                handleImageError(e, company.name, company.fallbackColor)
              }
            />
          </Box>
        ))}
