...
const mockTranslations = {
  workshop: {
    seo: {
      ...
      description:
        "Practical AI workshop for businesses with immediate results",
...
describe("WorkshopLandingPage", () => {
  ...
  it("renders SEO head with correct title and description", () => {
    ...
    expect(screen.getByTestId("seo-title")).toHaveTextContent(
      "AI Workshop - Low Hanging Fruits | 12 of Spades"
    );
  ...
  it("renders solution section", () => {
    ...
    expect(
      screen.getByText("Focus on immediate AI applications")
    ).toBeInTheDocument();
    expect(
      screen.getByText("Proven strategies with quick ROI")
    ).toBeInTheDocument();
  });
  ...
  it("renders final CTA section", () => {
    ...
    expect(
      screen.getByText("Ready for Your AI Breakthrough?")
    ).toBeInTheDocument();
    expect(
      screen.getByText(
        "Let us identify and pick the low hanging fruits together."
      )
    ).toBeInTheDocument();
  ...
  it("tests all workshop detail sections", () => {
    ...
    expect(
      screen.getByText("Concrete implementation steps")
    ).toBeInTheDocument();
