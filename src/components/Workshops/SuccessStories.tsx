import { Stack, Title, Text, Card, Box, ThemeIcon, Badge, Button, Group } from '@mantine/core';
import { IconMail, IconHeart, IconPhoto, IconClock, IconCurrencyEuro, IconTestPipe, IconRobot, IconSettings } from '@tabler/icons-react';
...
export const SuccessStories = () => {
  ...
  const ProcessVisualization = ({ story }: { story: StoryData }) => {
    const [isDesktopLayout, setIsDesktopLayout] = useState(() => window.innerWidth >= 1280);
    ...
    return (
      ...
      >
        ...
        {!isDesktopLayout ? (
          ...
          <Box style={{ position: 'relative', width: '100%', height: '60px', marginTop: '-10px', marginBottom: '-10px' }}>
            <svg 
              width="100%" 
              height="60"
            ...
            >
              ...
              >
                ...
                <Stack gap="lg" align="center">
                  <ThemeIcon size="xl" style={{ background: 'rgba(255,255,255,0.2)', color: 'white' }}>
                    <IconRobot size={32} />
                  </ThemeIcon>
                  <Box>
                    <Text fw={700} size="md" mb="xs">{story.processing.title}</Text>
                    ...
                    <Stack gap="xs">
                      <Box style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Box style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                          <IconClock size={16} />
                          <Text size="xs" fw={500}>Entwicklung:</Text>
                        </Box>
                        <Text size="xs" fw={600}>{story.implementation}</Text>
                      </Box>
                      <Box style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        <Box style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                          <IconCurrencyEuro size={16} />
                          <Text size="xs" fw={500}>Betrieb:</Text>
                        </Box>
                        <Text size="xs" fw={600}>{story.cost}</Text>
                      </Box>
                    </Stack>
                  </Box>
                </Stack>
          ...
          <Box style={{ position: 'relative', width: '100%', height: '60px', marginTop: '-10px', marginBottom: '-10px' }}>
            <svg width="100%" height="60" style={{ position: 'absolute', top: 0, left: 0 }} viewBox="0 0 100 60" preserveAspectRatio="xMidYMid meet">
              <motion.path
                d="M50,10 L50,50"
                stroke="var(--border-color)"
                strokeWidth="3"
              ...
              <circle cx="50" cy="10" r="4" fill="var(--primary-red)" opacity="0">
                <animate attributeName="cy" values="10;50" dur="2s" repeatCount="indefinite" begin="2s" />
                <animate attributeName="opacity" values="0;0.3;1;1;0.3;0" dur="2s" repeatCount="indefinite" begin="2s" />
              </circle>
              <circle cx="50" cy="10" r="3" fill="var(--primary-red)" opacity="0">
                <animate attributeName="cy" values="10;50" dur="2s" repeatCount="indefinite" begin="3s" />
                <animate attributeName="opacity" values="0;0.2;0.8;0.8;0.2;0" dur="2s" repeatCount="indefinite" begin="3s" />
              </circle>
              <circle cx="50" cy="10" r="3" fill="var(--primary-red)" opacity="0">
                <animate attributeName="cy" values="10;50" dur="2s" repeatCount="indefinite" begin="3.5s" />
                <animate attributeName="opacity" values="0;0.1;0.6;0.6;0.1;0" dur="2s" repeatCount="indefinite" begin="3.5s" />
              </circle>
            </svg>
          </Box>
                    ...
                    <Stack gap="xs" style={{ marginTop: '1rem' }}>
                      {Array.isArray(story.output.benefits) ? (
                        ...
                        story.output.benefits.map((benefit, i: number) => (
                          <Box key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5rem' }}>
                            <Text size="xs" c="green" style={{ marginTop: '0.1rem' }}>✓</Text>
                            <Text size="xs" c="var(--text-secondary)" style={{ lineHeight: 1.4 }}>
                              {benefit}
                            </Text>
                          </Box>
                        ...
                        <Stack gap="md">
                          <Box>
                            ...
                            <Stack gap="xs">
                              {story.output.benefits.oneTime.map((benefit, i: number) => (
                                <Box key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5rem' }}>
                                  <Text size="xs" c="green" style={{ marginTop: '0.1rem' }}>✓</Text>
                                  <Text size="xs" c="var(--text-secondary)" style={{ lineHeight: 1.4 }}>
                                    {benefit}
                          ...
                          <Box>
                            ...
                            <Stack gap="xs">
                              {story.output.benefits.ongoing.map((benefit, i: number) => (
                                <Box key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '0.5rem' }}>
                                  <Text size="xs" c="var(--primary-red)" style={{ marginTop: '0.1rem' }}>•</Text>
                                  <Text size="xs" c="var(--text-secondary)" style={{ lineHeight: 1.4 }}>
                                    {benefit}
                                  </Text>
                                </Box>
            ...
            <Box style={{ 
              ...
              >
                ...
                <circle cx="10" cy="100" r="4" fill="var(--primary-red)" opacity="0">
                  <animate attributeName="cx" values="10;110" dur="2s" repeatCount="indefinite" begin="2s" />
                  <animate attributeName="opacity" values="0;0.3;1;1;0.3;0" dur="2s" repeatCount="indefinite" begin="2s" />
                </circle>
                <circle cx="10" cy="100" r="3" fill="var(--primary-red)" opacity="0">
                  <animate attributeName="cx" values="10;110" dur="2s" repeatCount="indefinite" begin="3s" />
                  <animate attributeName="opacity" values="0;0.2;0.8;0.8;0.2;0" dur="2s" repeatCount="indefinite" begin="3s" />
                </circle>
                <circle cx="10" cy="100" r="3" fill="var(--primary-red)" opacity="0">
                  <animate attributeName="cx" values="10;110" dur="2s" repeatCount="indefinite" begin="3.5s" />
                  <animate attributeName="opacity" values="0;0.1;0.6;0.6;0.1;0" dur="2s" repeatCount="indefinite" begin="3.5s" />
                </circle>
              </svg>
            </Box>
      ...
      >
        <Stack gap="xl">
          <Stack gap="md" align="center" ta="center">
            ...
            <Text size="lg" c="var(--text-secondary)" style={{ whiteSpace: 'nowrap' }}>
            ...
            <Group gap="md" style={{ flexWrap: 'wrap' }}>
              {stories.map((story, index) => (
                <Button
                  ...
                  style={{
                    background: selectedStory === index 
                ...
                >
                  <Box style={{ 
                    ...
                    <Text size="sm" fw={600} style={{ 
                      color: selectedStory === index ? 'white' : 'var(--text-primary)' 
                    }}>
                      {story.title}
                    </Text>
                    <Badge 
                      ...
                      size="xs"
                      style={{
                        backgroundColor: selectedStory === index ? 'rgba(255,255,255,0.2)' : undefined,
                        color: selectedStory === index ? 'white' : undefined,
                        border: selectedStory === index ? '1px solid rgba(255,255,255,0.3)' : undefined
                      }}
                    >
                      {story.category}
                    </Badge>
          ...
          >
            <Stack gap="md" align="center" ta="center">
              <Text size="md" c="var(--text-secondary)" style={{ lineHeight: 1.5 }}>
                {stories[selectedStory].description}
              </Text>
              {stories[selectedStory].goal && (
                <Text size="md" fw={600} c="var(--primary-orange)" style={{ lineHeight: 1.4 }}>
                  {stories[selectedStory].goal}
                </Text>
              )}
            </Stack>
