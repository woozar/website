...
vi.mock('./TagList', () => ({
  TagList: ({ primaryTags, secondaryTags }: any) => (
    <div data-testid="tag-list">
      {primaryTags?.map((tag: string) => <span key={tag}>{tag}</span>)}
      {secondaryTags?.map((tag: string) => <span key={tag}>{tag}</span>)}
    </div>
  )
}));
...
describe('ImprovedProjectCard', () => {
  ...
  it('should handle project with empty primary tags', () => {
    ...
    render(<ImprovedProjectCard project={projectWithoutPrimaryTags} index={0} />);
  ...
  it('should handle project with empty secondary tags', () => {
    ...
    render(<ImprovedProjectCard project={projectWithoutSecondaryTags} index={0} />);
  ...
  it('should handle project with undefined primary tags', () => {
    ...
    render(<ImprovedProjectCard project={projectWithUndefinedTags} index={0} />);
  ...
  it('should truncate long titles correctly', () => {
    const longTitle = 'Very Long Project Title That Should Be Truncated'.repeat(3);
  ...
  it('should truncate long descriptions correctly', () => {
    const longDescription = 'Very long description that should be truncated. '.repeat(20);
    const projectWithLongDescription = { ...mockProject, description: [longDescription] };
    render(<ImprovedProjectCard project={projectWithLongDescription} index={0} />);
  ...
  it('should handle multiple description paragraphs', () => {
    ...
    render(<ImprovedProjectCard project={projectWithMultipleDescriptions} index={0} />);
