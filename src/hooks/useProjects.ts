...
const germanTranslations: { [key: string]: Partial<Project> } = {
  ...
  "AI Construction Tender Scraper": {
  ...
  "PAYZR - Pay-per-Use Billing System": {
  ...
  "Telent IoT Portal Modernization": {
